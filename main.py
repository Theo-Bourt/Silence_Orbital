...
if __name__ == "__main__":
    ...
    if skip.is_set():
        print(texte[texte.index(lettre):], end="")
        time.sleep(3)
    else:
        time.sleep(3)
